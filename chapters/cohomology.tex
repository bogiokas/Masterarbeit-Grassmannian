...
For the case of the finite Grassmannians, the following Theorem holds. A proof of this can be found in \cite{borel}. The approach employed here is unfortunately not complete.
...
\begin{center}
\begin{tikzcd}
0\ar[r]& A_{k,n-1}^{[k]}\ar[r]&A_{k,n}\ar[r]&A_{k-1,n-1}\ar[r]&0
\end{tikzcd}
\end{center}
...
This is a well known fact from combinatorics.
...
Unfortunately, this lemma is not complete
...
\begin{center}
\begin{tikzcd}
0\ar[r]&[-0.3em](\mathbb{Z}_2[w_1,\ldots,w_k]/I_{k,n-1})^{[k]}\ar[r,"\cdot w_k", "f"']&[-0.3em]\mathbb{Z}_2[w_1,\ldots,w_k]/I_{k,n}\ar[r,"w_i\mapsto\omega_i","g"']&[-0.3em]\mathbb{Z}_2[\omega_1,\ldots,\omega_{k-1}]/I_{k-1,n-1}\ar[r]&[-0.3em]0
\end{tikzcd}
\end{center}
